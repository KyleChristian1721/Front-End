...
<body class="home">
	...
	<header class="head" role="banner">
		...
		<div class="wrap clearfix">
			<a href="index.html" title="Meals for Makers" class="logo"><img src="images/ico/logo2.png" alt="Meals for Makers logo" /></a>
			...
			<nav class="main-nav" role="navigation" id="menu">
				<ul>
					...
					<li><a href="Messaging.html" title="Messaging"><span>Messaging</span></a>
						...
						<div class="entries row">
							...
							<div class="featured one-third">
								...
								<article class="entry">
									...
									<div class="container">
										<h2><a href="my_profile.html">April Kate P.</a></h2>
